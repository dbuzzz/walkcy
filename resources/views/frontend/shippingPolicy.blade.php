...
5.3       Although we make best possible efforts to transmit and store all the information provided by you in a secure operating environment that is not open to public, you understand and acknowledge that there is no such thing as complete security and we do not guarantee that there will be no unintended disclosures of any information and potential security breaches. You agree not to hold us responsible for any breach of security or for any action of any third parties that receive your Personal Information or events that are beyond our reasonable control including, acts of government, computer hacking, unauthorized access to computer data and storage device, computer crashes, breach of security and encryption, etc.
    ...
    <p>We currently ship to addresses within India. International shipping is not available at this time.</p>

    <h2>Processing Time</h2>
    <p>Orders are processed within 1-2 business days (excluding weekends and holidays) after receiving your order confirmation email. You will receive another notification when your order has shipped.</p>

    <h2>Shipping Rates and Estimates</h2>
    <p>Shipping charges for your order will be calculated and displayed at checkout.</p>
    <p>Estimated delivery times:</p>
    <ul>
        <li>Local (within Faizabad): 1-2 business days</li>
        <li>Within Uttar Pradesh: 3-5 business days</li>
        <li>Other States: 5-7 business days</li>
    </ul>
    <p>Please note these are estimated delivery times and actual delivery times may vary.</p>

    <h2>Shipping Methods</h2>
    <p>We use reliable courier services to ensure your order reaches you safely and promptly. Our primary shipping partners include:</p>
    <ul>
        <li>Blue Dart</li>
        <li>DTDC</li>
        <li>India Post</li>
    ...
    <p>Once your order has shipped, you will receive a shipping confirmation email that includes a tracking number. You can track your order using the link provided in the email or by visiting the courier service's website.</p>

    <h2>Shipping Address</h2>
    <p>Please ensure that your shipping address is correct and complete. Walkcy Shoe Showroom is not responsible for orders shipped to an incorrect address provided by the customer.</p>

    <h2>Delivery Issues</h2>
    <p>If you experience any issues with your delivery, such as delays or non-receipt, please contact our customer service team at <a href="mailto:customer.service@walkcy.com">customer.service@walkcy.com</a> or call us at +91-123-456-7890.</p>
    ...
    <p>For details on our return and exchange policy, please refer to our <a href="return-policy.html">Return Policy</a>.</p>

    <h2>Customer Service</h2>
    <p>For any other shipping-related inquiries, please contact our customer service team at <a href="mailto:help@walkcy.com">help@walkcy.com</a> or call us at 9335336433.</p>
