...
function edit(id = '') {
    $.ajax({
        url: siteUrl +"/department/edit",
        data: { id: id },
        type: 'GET',
        dataType: "json",
        success: function (res) {
            $("#id").val(res.data.id); 
            $("#department").val(res.data.name);
            $("#submit").text("Update");
            // reset();
