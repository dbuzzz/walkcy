...
function edit(id = '') {
    $.ajax({
        ...
        success: function (res) {
            ...
            $("#select03").val(res.data.attribute_id.split(',')).trigger('change');
