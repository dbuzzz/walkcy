$(document).ready(function(){
 ...
 function reset(){
    ...
    $('#image3').attr('src',siteUrl+'/uploads/default/default-image.jpg');
    show_project();
}   
...
function edit(id = '') {
    $.ajax({
        url: siteUrl +"/banner/edit",
        data: { id: id },
        type: 'GET',
        dataType: "json",
        success: function (res) {
            $("#id").val(res.data.id); 
            $("#cat1").val(res.data.cat_id1);
            $("#cat2").val(res.data.cat_id2);
            $("#cat3").val(res.data.cat_id3);
            $("#cat4").val(res.data.cat_id4);
            $("#image").attr("src",res.data.banner1);
            $("#image1").attr("src",res.data.banner2);
            $("#image2").attr("src",res.data.banner3);
            $("#image3").attr("src",res.data.banner4);
            // if (res.data.image1) {
