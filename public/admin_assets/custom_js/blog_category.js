...
$("#category_form").on("submit",function(e){
  ...
  $.ajaxSetup({
	...
	$.ajax({ 
		type:"post",
		url:siteUrl + "/blog-category/save",  
...
function show_project(){
	...
	var table = $('#cat_datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: siteUrl+"/blog-category/show",
        columns: [ 
            {data: 'DT_RowIndex'},
            {data: 'name', name: 'name'},
...
function deletes(id = ''){
    if (confirm("Are you sure!")) {
        $.ajax({
            url:siteUrl+"/blog-category/delete",
            type:'GET',
            data:{id:id},
...
function edit(id = '') {
    $.ajax({
        url: siteUrl +"/blog-category/edit",
        data: { id: id },
        type: 'GET',
        dataType: "json",
        success: function (res) {
...
function status(id = "", status = "") {
    $.ajax({
        url: siteUrl +"/blog-category/status",
